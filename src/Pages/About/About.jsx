    ...
    return (
        <S.About theme={theme} id="About">
            <S.Container>
                ...
                <S.Text theme={theme}>I'm currently studying Computer Engineering in the Federal University of Rio Grande do Norte.</S.Text>
                ...
                <S.Text theme={theme}>Atualmente estou cursando Engenharia de Computação na Universidade Federal do Rio Grande do Norte.</S.Text>
                ...
                <S.Text theme={theme}>JavaScript, HTML, CSS, React, </S.Text>
                <S.Text theme={theme}>StyledComponents, GIT,C++.</S.Text>
                </S.Container>
            </S.Container>
        </S.About>
    )
