...
const Card = ({ project, index }: propsType) => {
  ...
  return (
    <div ref={ref}>
      <motion.div
        className={`gap-5 ${index % 2 != 0 && "flex-row-reverse "} flex p-5 rounded-lg `}
        style={{ x }}
      >
        <div className="flex flex-col gap-2 items-center">
          ...
          <div className="flex gap-2">
            <Link href={project.github} target="_blank" className="gap-2 font-bold text-2xl px-4 py-1 border border-gray-400 flex items-center justify-center rounded-lg">
              GitHub
              <FaGithub />
            </Link>
            <Link href={project.deploy} target="_blank" className="gap-2 font-bold text-2xl px-4 py-1 border border-gray-400 flex items-center justify-center rounded-lg">
              Deploy
              <FaExternalLinkAlt />
            </Link>
          </div>
